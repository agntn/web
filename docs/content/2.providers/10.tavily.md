...
- A spent plan or pay-as-you-go cap comes back as HTTP 432 or 433, not 402. Both are `PaymentError` here, so automatic search moves on to the next configured provider. A wrong key is still 401 and still stops the chain.
