    ...
    "results": [
      {
        ...
        "snippet": "NitroJS LogoNitroJS Logo\n\nNitroJS LogoNitroJS Logo\n\n# Cloudflare\n\nDeploy Nitro apps to CloudFlare.\n\n## Cloudflare Workers\n\nPreset: `cloudflare` (switch to this preset)\n\nNote: This preset uses service-worker syntax for deployment.\n\nWarning: Please be aware that `runtimeConfig` cannot be updated via Cloudflare's environment variables (see #272 for more). As a workaround, you can use the Cloudflare…",
        "score": 0.8967681
      },
      {
        "url": "https://nitro.build/deploy/providers/cloudflare",
        "title": "Cloudflare",
        "snippet": "Nitro\n\nDeploy Nitro apps to Cloudflare.\n\n## #Cloudflare Workers\n\nPreset: `cloudflare_module`\n\nRead more in Cloudflare Workers.\n\nIntegration with this provider is possible with zero configuration supporting workers builds (beta).\n\nThe following shows an example `nitro.config.ts` file for deploying a Nitro app to Cloudflare Workers.\n\nnitro.config.ts\n\n```\nimport{} from \"nitro\" export default defineC…",
        "score": 0.8839694
      },
      {
        "url": "https://nitro.zhcndoc.com/deploy/providers/cloudflare",
        "title": "Cloudflare - Nitro 中文文档",
        "snippet": "Nitro 中文文档 logoNitro 中文文档\n\n# Cloudflare\n\n将 Nitro 应用部署到 Cloudflare。\n\n## Cloudflare Workers\n\n预设： `cloudflare_module`\n\nRead more in Cloudflare Workers.\n\n通过与该提供商的集成支持 workers builds (beta)，可以实现零配置。\n\n下面展示了用于将 Nitro 应用部署到 Cloudflare Workers 的示例 `nitro.config.ts` 文件。\n\nnitro.config.ts\n\n```\nimport { defineConfig } from \"nitro\"; import { defineConfig } from  \"nitro\";   export default defineConfig({ export…",
        "score": 0.8810534
      },
      {
        "url": "https://github.com/nitrojs/nitro/discussions/2876",
        "title": "Confused about which Cloudflare preset to use and basic ...",
        "snippet": "me. Wrangler Preset vs Nitro Present This is where it gets interesting: If I create worker for Nuxt based on CF's own recommended command `npm create cloudflare@latest my-nuxt-app -- --framework=nuxt --experimental`, I see this is set as the Nitro preset:  ``` {preset\"./cloudflare-preset\"} ```  And the preset generated by wrangler is:  ``` import{type NitroPreset} from \"nitropack\"; export default…",
        "score": 0.8497846,
        "publishedDate": "2024-11-13T00:00:00.000Z"
      },
      {
        "url": "https://keith-mifsud.me/blog/nuxt-and-cloudflare-vectorize-setting-up-d1-drizzle-and-workers-ai",
        "title": "Nuxt & Cloudflare Vectorize: Setting up D1, Drizzle, and ...",
        "snippet": "```\nexport default defineNuxtConfig({ export  default  defineNuxtConfig({  compatibilityDate: '2025-12-06',  compatibilityDate: '2025-12-06',  devtools: { enabled: true },  devtools: { enabled: true },  modules: [  modules: [  'nitro-cloudflare-dev',  'nitro-cloudflare-dev',  ],  ],  nitro: {  nitro: {    preset: 'cloudflare_module',  preset: 'cloudflare_module',    experimental: {  experimental:…",
        "score": 0.6816637,
      ...
      "results": [
        {
          ...
          "snippet": "Cloudflare Workers is the new recommended preset for deployments.",
        ...
        },
        {
          ...
          "snippet": "Workers Sites is practically unofficially deprecated in favour of Pages so that's the reason why the module workers preset is not recommended (not because we specifically want people not to use wor…",
          "favicon": "https://imgs.search.brave.com/xxsA4YxzaR0cl-DBsH9-lpv2gsif3KMYgM87p26bs_o/rs:fit:32:32:1:0/g:ce/aHR0cDovL2Zhdmlj/b25zLnNlYXJjaC5i/cmF2ZS5jb20vaWNv/bnMvYWQyNWM1NjA5/ZjZmZjNlYzI2MDNk/N2VkNmJhYjE2MzZl/MDY5ZTMxMDUzZmY1/NmU3NWIzNWVmMjk0/NTBjMjJjZi9naXRo/dWIuY29tLw",
          "providers": [
            "brave"
          ]
    ...
    "fanout": {
      "results": [
        ...
        },
        {
          "url": "https://vercel.com/academy/ai-sdk/tool-use",
          "title": "Tool Use | Vercel Academy",
          "snippet": "Model Generates Tool Call: Outputs structured request to call specific tool with inferred parameters. SDK Executes Tool: API route receives call, SDK invokes execute function.",
          "favicon": "https://imgs.search.brave.com/BNSQrXn2bmeJXUV454rdF3_0T8nAzszmcKdxq9LZbwQ/rs:fit:32:32:1:0/g:ce/aHR0cDovL2Zhdmlj/b25zLnNlYXJjaC5i/cmF2ZS5jb20vaWNv/bnMvZDQ5YzljMTg4/MmJjMjJkYzEzMWZi/YmYyODM3ZjEyYzEw/MjY5OWFlM2I5YTY1/YmZhNTJlY2EwM2Iz/N2RhMWIxOC92ZXJj/ZWwuY29tLw",
          "providers": [
            "brave",
            "exa",
