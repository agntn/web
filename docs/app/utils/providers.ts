...
export const PROVIDERS: readonly ProviderInfo[] = [
  ...
  },
  {
    ...
    envVar: "MARGINALIA_API_KEY",
    auth: "API-Key header",
    host: "api2.marginalia-search.com",
    freeTier: "shared public key, free own key by email",
    search: true,
    searchImage: false,
    read: false,
    filters: [],
  ...
  },
  {
    ...
    pagination: false,
    resultLimit: "10, up to 100 sources locally",
    resultFields: [],
    readFormats: [],
    readOptions: [],
  ...
  },
  {
    ...
    auth: "request body for search, Bearer header for read",
    host: "api.tavily.com",
    freeTier: "1k queries a month",
    search: true,
    searchImage: false,
